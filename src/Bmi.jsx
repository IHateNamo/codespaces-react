...
function BmiText({bmi}){
    if(bmi<18.5) 
        return (<><h1><img src="AnimeGirl.png" className="FAT" /><br/>Underweight</h1></>);
    if(bmi>30) 
        return (<><h1><img src="FAT2.png" className="FAT" /><br/>Overrweight</h1></>);
    return (<><h1><img src="normal.png" className="FAT" /><br/>Normal</h1></>);
 }
